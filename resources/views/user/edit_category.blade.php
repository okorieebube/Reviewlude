                                                ...
                                                <div class="col-md-11 mx-auto">
                                                    ...
                                                    <div class="platform-div">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="id" value="{{ $category->unique_id }}">
                                                            <input type="text" class="form-control mb-4" name="name" placeholder="Enter name of this category*" value="{{ $category->name }}" >
                                                        </div>
                ...
                // require(['jquery','Basic_function'], function($,Basic_function) {
                    ...
                    $(document).ready(function() {
                        ...
                        $('.password_update_btn').click(async function(e) {
                            ...
                            // let empty_data = [];
                            // basic info
                            let data = $('.password_update_form').serializeArray();
                            // console.log(data);
                            // return;

                            // append to form data object
                            let form_data = set_form_data(data);
                            let returned = await ajaxRequest('/update_category', form_data);
                            // console.log(returned);return;
                        validator(returned, '/user/category/'+data[1].value);
                        });
