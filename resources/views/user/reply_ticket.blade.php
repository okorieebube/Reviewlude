                            ...
                            <div class="row">
                                <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                                    <form id="work-platforms" class="section work-platforms reply_support_form">
                                        @csrf
                                        <div class="info widget-content-area">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="accordion" id="hd-statistics">
                                                                {{-- <div class="card"> --}}
                                                                    <div style="border-bottom:none" class="card-header" id="hd-statistics-2">
                                                                        <div class="mb-0">
                                                                            <div class=" collapsed" role="navigation" aria-expanded="true" aria-controls="collapse-hd-statistics-2">
                                                                                <h6>TICKET ID: {{ $main_ticket->unique_id }}</h6>
                                                                            </div>
                                                                            <div class=" collapsed text-capitalize" role="navigation" aria-expanded="true" aria-controls="collapse-hd-statistics-2">
                                                                                <h6>TITLE: {{ $main_ticket->title }} </h6>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="collapse-hd-statistics-2" class="collapse show" aria-labelledby="hd-statistics-2" data-parent="#hd-statistics">
                                                                        ...
                                                                        <div class="card-body mt-2 mb-2 msg-card">
                                                                            <p class="text-warning">Email: {{ $e->user->email }}</p>
                                                                            <p class="text-capitalize">{{ $e->message }}</p>
                                                                            <p class="text-warning">{{ $e->created_at->diffForhumans() }} </p>
                                                                        </div>
                                                                        @endforeach
                                                        ...
                                                        <div class="col-md-12">
                                                            <form class="reply_support_form">
                                                                <input type="hidden" name="main_id" value="{{ $main_ticket->unique_id }}">
                                                                <input type="hidden" name="reply_ticket_title" value="{{ $main_ticket->title }}">
                                                        ...
                                                        <div class="col-md-3 text-right mb-5">
                                                            ...
                                                            <a href="{{ route('create_ticket') }}" class="btn btn-dark ">New Ticket</a>
                                                                @endif
                                                            <!-- </a> -->
                                                        </div>
                                                        <div class="col-md-3 text-right mb-5">
                                                            <button id="add-work-platforms" class="btn btn-primary reply_support_btn">Reply Ticket</button>
                                                        </div>
                                                    </div>
                                                {{-- </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.reply_support_btn').click(async function(e) {
                    ...
                    let returned = await ajaxRequest('/ticket/reply/'+data[1].value, form_data);
                    // console.log(returned);
                    // return;
                    validator(returned, '/user/ticket/reply/'+data[1].value);
                });
