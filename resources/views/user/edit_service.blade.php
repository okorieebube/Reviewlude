                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control mb-4" name="name" placeholder="Enter name of service*" value="{{ $the_product->name }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control form_tags mb-4" data-role="tagsinput" value="{{ $the_product->tags }}" placeholder="Add tags associated with your service">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="modal-text">
                                If the details for this service is corrected, click the update button below to continue.
                            </p>
                        </div>
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    $('.create_product_btn').click(async function(e) {
                        ...
                        // return;
                        validator(returned, '/user/service/'+basic_info[1].value);
                    });
