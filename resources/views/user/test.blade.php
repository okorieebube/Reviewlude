                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a style="background-color: #6730e3" href="{{ $site_root }}email-confirmation/{{ $details->unique_id }}" target="_blank">Reset Password</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">{{ $address }}</span> <!-- address -->
                    <br> Like to check us out? <a href="{{ $site_root }}en/">{{ $site_name }}.com</a>.
                    <!-- site_name & url -->
                  </td>
                </tr>
                <tr>
