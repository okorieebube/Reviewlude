...
trait appFunction
{
    ...
    {
        $ini = array('ABTUJ', 'DCTUJ', 'EBTUJ', 'FXTUJ', 'GITUJ', 'CDTUJ', 'MPTUJ', 'NTTUJ', 'XRTUJ', 'XATUJ', 'XBTUJ', 'XCTUJ', 'XDTUJ', 'VATUJ', 'BVTUJ', 'VBTUJ', 'VOTUJ', 'VUCFR', 'VXCFR', 'RPCFR', 'OPCFR', 'UYCFR', 'YZCFR', 'YSCFR', 'YXCFR', 'YECFR', 'WUCFR', 'WVCFR', 'WOCFR', 'WCCFR', 'WMCFR', 'MWCFR', 'XICFR', 'XSCFR', 'SOCFR', 'SPCFR', 'SSCFR', 'SBCFR', 'SCCFR', 'SRCFR', 'SXCFR', 'SVCFR', 'SJCFR', 'JDCFR', 'JUCFR', 'JKCFR', 'KVNVC', 'JVNVC', 'JWJOL', 'KJJOL', 'REJOL', 'REJOL', 'RDJOL', 'LOJOL', 'JHJOL', 'KNJOL', 'MKJOL', "RAJOL", "RBJOL", "RHJOL", "RKJOL", "RWJOL", "RBJOL", "RFJOL", "RGJOL", "RHJOL", "RJJOL", "RKJOL", "TLJOL", "TZJOL", "TXJOL", "TCJOL", "TVJOL", "TBJOL", "TNJOL", "TDJOL", "TDJOL", "TTJOL", "TAJOL", "JEJOL", "JXJOL", "JLJOL", "KJJOL", "IHJOL", "TAJOL", "TSJOL", "TSNVC", "TZNVC", "TQNVC",);
        $key = array_rand($ini);
        $value = $ini[$key];
        $key2 = array_rand($ini);
        $value2 = $ini[$key2];
